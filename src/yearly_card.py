...
parser = argparse.ArgumentParser(prog="yearly_card.py", help="Your yearly card")
parser.add_argument("-d", help="Birth Day of Month", type=int)
parser.add_argument("-m", help="Birth Month of Year", type=int)
parser.add_argument("-y", help="Four digit Year for Reading", type=int)
